 ...
 * @author Jaume Ribas
 */
public class GameOverMenuScene extends MenuScene implements GameScene {
	...
	public GameOverMenuScene(Camera camera, Engine engine, Context context, IOnMenuItemClickListener listener) {
		super(camera);
